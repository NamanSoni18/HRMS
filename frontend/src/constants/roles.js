...
export const ROLE_GROUPS = {
    TOP_MANAGEMENT: [ROLES.ADMIN, ROLES.CEO],
    MIDDLE_MANAGEMENT: [ROLES.INCUBATION_MANAGER, ROLES.ACCOUNTANT, ROLES.OFFICER_IN_CHARGE, ROLES.FACULTY_IN_CHARGE],
    STAFF: [ROLES.EMPLOYEE],
    MANAGERS: [ROLES.ADMIN, ROLES.CEO, ROLES.INCUBATION_MANAGER, ROLES.ACCOUNTANT, ROLES.OFFICER_IN_CHARGE, ROLES.FACULTY_IN_CHARGE, ROLES.EMPLOYEE],
