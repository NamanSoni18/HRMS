...
/**
 * Filter users by minimum hierarchy level
 * Users with the specified level and higher (2, 3, 4, etc.) will be included
 * @param {Array} users - Array of user objects
 * @param {number} minimumLevel - Minimum hierarchy level to include (default: 2)
 * @returns {Array} Filtered users
 */
export const filterUsersByLevel = (users, minimumLevel = 2) => {
