...
import { LayoutDashboard, FileText, Users, Settings as SettingsIcon, LogOut, Menu, Star, CalendarCheck, Clock, DollarSign, FolderOpen, UserCircle } from 'lucide-react';
...
const Dashboard = ({ onLogout }) => {
    ...
    const stats = [
        { id: 1, label: 'Total Employees', value: String(dashboardData.stats.totalEmployees), color: 'teal' },
        { id: 2, label: 'Present Today', value: String(dashboardData.stats.presentToday), color: 'emerald' },
        { id: 3, label: 'On Leave', value: String(dashboardData.stats.onLeave), color: 'amber' },
        ...
        <div className="ceo-dashboard">
            <header className="ceo-header">
                ...
                <div className="ceo-header-right">
                    ...
                    <button className="profile-edit-btn" onClick={() => setActiveView('profile')}>
                        <UserCircle size={20} />
                    ...
                    <div className="attendance-list">
                        {employeeAttendance.map((emp, idx) => (
                            <div key={idx} className="attendance-item">
                                <div className="emp-avatar-small">{emp.name.split(' ').map(n => n[0]).join('')}</div>
