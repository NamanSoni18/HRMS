...
const AccountantLeaveManagement = () => {
    const { user } = useAuth();
            ...
            <body>
                ...
                <div class="doc-content">
                    <div class="to-section">
                        ...
                        <p>The Chief Executive Office/Faculty In charge</p>
                    ...
                    <div class="office-section">
                        ...
                        <div class="approval-row">
                            <p><strong>Recommended/Not Recommended</strong></p>
                            <p><strong>Approved / Not Approved</strong></p>
                        </div>
                        <div class="approval-row">
                            <p><strong>CEO, NITRRFIE</strong></p>
                        ...
                        <div className="document-page" ref={formRef} id="leave-form">
                            ...
                            <div className="doc-content">
                                ...
                                <div className="office-section">
                                    ...
                                    <div className="approval-row" style={{ marginTop: '30px' }}>
                                        <p><strong>CEO, NITRRFIE</strong></p>
                                        <p><strong>Faculty In-charge, NITRRFIE</strong></p>
                                    </div>
                                </div>
...
export default AccountantLeaveManagement;
